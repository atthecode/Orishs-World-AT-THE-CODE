const CACHE='orish-world-v129-explorer-3d';
const SHELL=[
  ...
  './assets/models/explorer-premium-v1.glb','./assets/at-the-code-mark.webp','./assets/orish-explorer.webp','./assets/fossil-detective.webp','./assets/fraction-rescue.webp','./assets/learning-adventures.webp','./assets/icon-192.png','./assets/icon-512.png','./assets/icon-maskable-192.png','./assets/icon-maskable-512.png','./assets/apple-touch-icon.png'
];
...
self.addEventListener('fetch',(event)=>{
  ...
  if(url.pathname.endsWith('/modules/avatar-3d-viewer.js')||url.pathname.endsWith('/modules/avatar-lab-engine.js')||url.pathname.endsWith('/assets/models/explorer-premium-v1.glb')){
