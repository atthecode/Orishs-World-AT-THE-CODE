...
This prototype is plain HTML, CSS and JavaScript. It has:
...
## Child-safety decisions in this prototype
...
Open `index.html` in a modern browser. No build command is required.

For a local HTTP server, from this folder you can also run:
...
2. Add the approved Orish character asset and animation rather than inventing a replacement character.
3. Add parent-owned profiles and age settings only when the wider Orish's World account architecture is ready.
4. Expand the authored mission library and safety test coverage.
