const CACHE='orish-world-v165-older-game-library';
const SHELL=[
  ...
  './world-map.html','./world-map.css','./world-map-play.css','./world-map.js','./world-map-play.js','./older-games.css','./space-signal.html','./space-signal.css','./space-signal.js','./signal-detective.html','./signal-detective.js','./fossil-detective.html','./fossil-detective.css','./fossil-detective-fixes.css','./fossil-detective.js','./life-city.html','./life-city.css','./life-city-play.css','./life-city-play.js','./life-city.js','./grid-rescue.html','./grid-rescue.js','./learning-cinema.html','./learning-cinema-v3.css','./learning-cinema-v3.js',
