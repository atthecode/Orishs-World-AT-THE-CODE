const CACHE='orish-world-v164-play-first-navigation';
const SHELL=[
  ...
  './world-map.html','./world-map.css','./world-map-play.css','./world-map.js','./world-map-play.js','./space-signal.html','./space-signal.css','./space-signal.js','./fossil-detective.html','./fossil-detective.css','./fossil-detective-fixes.css','./fossil-detective.js','./life-city.html','./life-city.css','./life-city-play.css','./life-city-play.js','./life-city.js','./learning-cinema.html','./learning-cinema-v3.css','./learning-cinema-v3.js',
